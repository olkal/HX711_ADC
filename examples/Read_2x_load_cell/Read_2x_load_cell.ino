...
//-------------------------------------------------------------------------------------
// This is an example scetch on how to use two HX711 modules with simultanious operation. 
...
void setup() {
  ...
  while((ldcell_1_rdy + ldcell_2_rdy) < ldcells) { //run startup, stabilization and tare, both modules
    ldcell_1_rdy = LdCell_1.startMulti(stabilizingtime);
    ldcell_2_rdy = LdCell_2.startMulti(stabilizingtime);
  }
